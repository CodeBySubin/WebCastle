...
import 'package:webcastle/features/home/presentation/widgets/latest_product_only.dart';
...
import 'package:webcastle/features/home/presentation/widgets/latest_products.dart';
                ...
                loaded: (home) => SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      RfqBanner(
                        banner: home.data.homeFields[5].image.toString(),
                      ),
                      ...
                      LatestProducts(
                        products: home.data.homeFields[9].products!,
                      ),

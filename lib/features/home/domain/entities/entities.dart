class HomeEntity {
  ...
  HomeEntity({required this.errorCode, required this.message, required this.data});
}
...
class HomeDataEntity {
  ...
  HomeDataEntity({required this.homeFields, required this.notificationCount});
}
...
class BannerEntity {
  ...
  BannerEntity({required this.id, required this.image, required this.type});
}
